...
> Step selanjutnya :
1. Backend paket LEADS
3. Backend Admin Beranda - generate data dalam bentuk excel dan pdf
4. Backend Admin Invoice - Desain Kode generate Invoice untuk Admin
5. Backend Admin Kwitansi - Desain Kode generate Kwitansi untuk Admin - INVOICE di ganti PAID berwarna hijau
6. Untuk desain invoice dan kwitansi di link gdrive di bawah ini:
